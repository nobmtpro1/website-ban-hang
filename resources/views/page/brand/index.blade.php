                        ...
                        <div class="topbar-left">
                            ...
                            <aside class="sidebar-content">
                                ...
                                <ul class="sidebar-tags">
                                    ...
                                    <li><a href="{{$a->c_slug}}">{{$a->c_name}}</a></li>
                                    @endforeach
                                </ul>
                            </aside>
                            @foreach($attr as $a)
                            <aside class="sidebar-content">
                                ...
                                <ul class="sidebar-tags">
                                    ...
                                    <li><a href="category/{{$b->id}}">{{$b->a_name}}</a></li>
                                    @endforeach
                                </ul>
                            </aside>
                            @endforeach
                                            ...
                                            <div class="two-product">
                                                ...
                                                <div class="single-product">
                                                    ...
                                                    <div class="product-img">
                                                        <a href="#">
                                                            <img style="height: 200px" class="primary-image" src="upload/{{$p->p_avatar}}" alt="" />
                                                            <img style="height: 200px" class="secondary-image" src="upload/{{$p->p_avatar}}" alt="" />
                                                        </a>
                                                        ...
                                                        <div class="price-box">
                                                            <span class="new-price">${{$p->p_price}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="product-content">
                                                        <h2 class="product-name"><a href="#">{{$p->p_name}}</a></h2>
                                                        <p>{{$p->p_description}}</p>
                                                    </div>
                                                </div>
                                                <!-- single-product end -->
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-7.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-2.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-7.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-8.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-5.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-6.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-11.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-12.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-9.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-10.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-6.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-7.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-4.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-5.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-2.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-3.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="product-list-wrapper">
                                        <div class="single-product">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="frontend/img/products/product-1.jpg" alt="" />
                                                        <img class="secondary-image" src="frontend/img/products/product-1.jpg" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-8 col-sm-8 col-xs-12">
